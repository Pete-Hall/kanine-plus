...
router.put('/', (req, res) => {
  ...
  const queryString = `UPDATE dog SET "dog_name"=$1, "address"=$2, "breed"=$3, "age"=$4, "monday"=$5, "tuesday"=$6, "wednesday"=$7, "thursday"=$8, "friday"=$9, "owner_name"=$10, "owner_email"=$11, "owner_phone_one"=$12, "owner_phone_two"=$13, "pick_up"=$14, "drop_off"=$15, "originID"=$16, "driving_routeID"=$17, "gender"=$18 WHERE id=$19;`
